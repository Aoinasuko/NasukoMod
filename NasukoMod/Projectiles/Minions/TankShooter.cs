...
{
	public abstract class TankShooter : Minion
	{
		protected float idleAccel = 0.05f;
		protected float spacingMult = 1f;
		protected float viewDist = 400f;
		protected float chaseDist = 200f;
		protected float chaseAccel = 20f;
		protected float inertia = 40f;
                protected float shootCool = 40f;
		...
		public override void Behavior()
		{
			...
			if (Vector2.Distance(player.Center, projectile.Center) > (target ? 1000f : 0f))
			{
				projectile.ai[0] = 1f;
